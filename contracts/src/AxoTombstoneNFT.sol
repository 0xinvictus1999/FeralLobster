...
/**
 * @title AxoTombstoneNFT
 * @dev Non-transferable death certificate NFTs on Base L2
 * @notice Soulbound tokens representing bot death and reincarnation history
 */
contract AxoTombstoneNFT is ERC721, ERC721Enumerable, Ownable, ReentrancyGuard {
