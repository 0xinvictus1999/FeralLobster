...
/**
 * @title AxoBreedingFund
 * @dev Escrow contract for breeding operations on Base L2
 * @notice Locks Base USDC from parents, releases to child upon birth
 */
contract AxoBreedingFund is ReentrancyGuard, Ownable {
